    ...
    <section id="themes" class="py-24 sm:py-32 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="text-center mt-14">
                <a href="{{ route('register') }}" class="group inline-flex items-center gap-2 px-8 py-4 text-rose-600 font-semibold hover:text-rose-700 bg-rose-50 hover:bg-rose-100 rounded-2xl transition-all">
                    Lihat Semua Tema
